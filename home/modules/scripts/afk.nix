{pkgs, ...}: {
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      # every routing decision against; jq parses the stream-json events;
      # util-linux provides uuidgen for the session IDs.
      runtimeInputs = [pkgs.claude-code pkgs.tatr pkgs.git pkgs.jq pkgs.coreutils pkgs.util-linux];
