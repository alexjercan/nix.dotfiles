...
- [ ] Action Item - budgets: set `BUDGET_ROUTER_BODY=300`,
...
- [ ] Action Item - flow: compact `flow/SKILL.md` to at most 300 body words;
      compact every `flow/*.md` reference to at most 600 words.
- [ ] Action Item - plan: compact `plan/SKILL.md` to at most 400 body words;
      compact every `plan/*.md` reference to at most 600 words.
- [ ] Action Item - work: compact `work/SKILL.md` to at most 400 body words;
      compact every `work/*.md` reference to at most 600 words.
- [ ] Action Item - review: compact `review/SKILL.md` to at most 400 body
      words; compact every `review/*.md` reference to at most 600 words.
- [ ] Action Item - spike: compact `spike/SKILL.md` to at most 400 body words;
      keep every `spike/*.md` reference within 600 words.
- [ ] Action Item - compound: compact `compound/SKILL.md` to at most 400 body
      words.
- [ ] Action Item - lessons: compact `lessons/SKILL.md` to at most 400 body
      words; compact every `lessons/*.md` reference to at most 600 words.
- [ ] Action Item - sprout: compact `sprout/SKILL.md` to at most 400 body
      words; keep every `sprout/*.md` reference within 600 words.
- [ ] Action Item - today: compact `today/SKILL.md` to at most 400 body words.
- [ ] Inventory each edited file's imperative rules before rewriting; retain
...
- [ ] Run the skill gate, tatr gates, and full flake checks.
